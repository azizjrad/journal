          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-300 text-sm">
                ...
                <span>{t("address", "Tripoli, Libya", "طرابلس، ليبيا")}</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-3 border-t border-gray-800">
                <div className="text-gray-400 text-xs mb-3 flex items-center gap-2">
                  ...
                  {t("live_updates", "Live Updates", "تحديثات مباشرة")}
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="inline-flex items-center px-2 py-1 bg-red-600 text-white rounded-full">
                      <span className="w-1.5 h-1.5 bg-white rounded-full mr-1 animate-pulse"></span>
                      {t("breaking", "BREAKING", "عاجل")}
                    </span>
                    <span className="text-gray-500">
                      {t("last_updated", "2 min ago", "منذ دقيقتين")}
                    </span>
                  </div>
